...
let Guests :string[] = ["Hamza","Rehan","Danish","Imran","Azan","Asad"];
...
let languages:string[]=["Urdu","Arabic","Spanish","German","English"]
...
//  these items.
let Driving:{Car:string,Name:string,established:number} ={
    Car:"Tesla",
    Name:"Model Y",
    established:2024
}
...
let userNames :string[]=["Sheraz","Bilal","Mohsin"];
...
let favCricketer :string ="Babar Azam";
...
let foods:string[]=["Pizza","Karai","Niyari"]
